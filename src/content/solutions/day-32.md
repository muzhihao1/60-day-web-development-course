...
files:
  - path: "TaskManager.jsx"
    language: "jsx"
    description: "完整的任务管理系统实现，包含Redux store配置和UI组件"
  - path: "CollaborativeWhiteboard.jsx"
    language: "jsx"
    description: "实时协作白板应用，集成WebSocket和Redux"
  - path: "EcommerceAdmin.jsx"
    language: "jsx"
    description: "电商后台管理系统，使用RTK Query进行数据管理"
keyTakeaways:
...
extensions:
  - title: "实现离线支持与背景同步"
    description: "使用Service Worker和背景同步API实现离线数据同步"
  - title: "添加Redux持久化和数据迁移"
    description: "使用redux-persist库实现状态持久化和版本迁移"
  - title: "集成Redux与Service Worker"
    description: "在Service Worker中使用Redux管理离线状态"
  - title: "实现时间旅行调试功能"
    description: "创建自定义的时间旅行调试工具，可视化状态变化"
  - title: "创建Redux DevTools插件"
    description: "开发自定义的Redux DevTools扩展，增强调试体验"
---
