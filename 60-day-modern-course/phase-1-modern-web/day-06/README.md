    ...
    <div class="min-h-full">
        ...
        <main class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                <button class="relative group bg-white dark:bg-gray-800 p-6 rounded-lg shadow hover:shadow-lg transition-all duration-200 text-left">
                    <div class="flex items-center">
                        ...
                        <div class="ml-3">
                            <p class="text-sm font-medium text-gray-900 dark:text-white">新建项目</p>
                            <p class="text-xs text-gray-500 dark:text-gray-400">创建新的项目</p>
                        </div>
                    </div>
                ...
                <button class="relative group bg-white dark:bg-gray-800 p-6 rounded-lg shadow hover:shadow-lg transition-all duration-200 text-left">
                    <div class="flex items-center">
                        ...
                        <div class="ml-3">
                            <p class="text-sm font-medium text-gray-900 dark:text-white">查看任务</p>
                            <p class="text-xs text-gray-500 dark:text-gray-400">12个待处理</p>
                        </div>
                    </div>
                    <div class="absolute top-2 right-2 opacity-0 group-hover:opacity-100 transition-opacity">
                        <svg class="h-4 w-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <button class="relative group bg-white dark:bg-gray-800 p-6 rounded-lg shadow hover:shadow-lg transition-all duration-200 text-left">
                    <div class="flex items-center">
                        ...
                        <div class="ml-3">
                            <p class="text-sm font-medium text-gray-900 dark:text-white">团队成员</p>
                            <p class="text-xs text-gray-500 dark:text-gray-400">添加新成员</p>
                        </div>
                    </div>
                    <div class="absolute top-2 right-2 opacity-0 group-hover:opacity-100 transition-opacity">
                        <svg class="h-4 w-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <button class="relative group bg-white dark:bg-gray-800 p-6 rounded-lg shadow hover:shadow-lg transition-all duration-200 text-left">
                    <div class="flex items-center">
                        ...
                        <div class="ml-3">
                            <p class="text-sm font-medium text-gray-900 dark:text-white">设置</p>
                            <p class="text-xs text-gray-500 dark:text-gray-400">系统配置</p>
                        </div>
                    </div>
                    <div class="absolute top-2 right-2 opacity-0 group-hover:opacity-100 transition-opacity">
                        <svg class="h-4 w-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
